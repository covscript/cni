...
#define CNI(NAME) CNI_REGISTER(NAME, cs::make_cni(NAME))
#define CNI_CONST(NAME) CNI_REGISTER(NAME, cs::make_cni(NAME))
#define CNI_VISITOR(NAME) CNI_REGISTER(NAME, cs::make_cni(NAME))
#define CNI_V(NAME, ARGS) CNI_REGISTER(NAME, cs::make_cni(ARGS))
#define CNI_CONST_V(NAME, ARGS) CNI_REGISTER(NAME, cs::make_cni(ARGS))
#define CNI_VISITOR_V(NAME, ARGS) CNI_REGISTER(NAME, cs::make_cni(ARGS))
